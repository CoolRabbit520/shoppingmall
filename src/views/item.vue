 			...
 			<div class="item-box">
 				<div class="gallery-wrapper">
 					<div class="gallery">
 						<div class="thumbnail">
 							<ul>
 								<li @click="tableiImg(index)" :class="{'on':index==imgIndex}" v-for="(img,index) in itemInfo.ali_images"><img :src="img+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'"></li>
 							</ul>
 						</div>
 						<div class="thumb">
 							<ul>
 								<li :class="{'on':index==imgIndex}" v-for="(img,index) in itemInfo.ali_images"><img :src="img+'?x-oss-process=image/resize,w_400/quality,Q_90/format,webp'"></li>
 							</ul>
 						</div>
 					</div>
 				</div>
 					...
 					<div class="sku-dynamic-params-panel">
 						<div class="sku-dynamic-params clear">
 							...
 							<ul class="params-colors">
 								<li :class="{'cur':item.id==itemId}"  v-for="(item, index) in itemInfo.sku_list">
 									<router-link :title="item.color" :to="{name:'Item',query:{itemId:item.id}}" ><img :src="'http://img01.smartisanos.cn/'+item.image+'20X20.jpg'"></router-link>
 								</li>
 							</ul>
 						</div>
 						<div class="sku-dynamic-params clear">
 ...
 import prompt from '../components/prompt'
 	...
 	export default{
        ...
        prompt
 		...
 		watch:{
 			"$route.query.itemId":function(val,oldVal){
